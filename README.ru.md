...
**Удобное, быстрое или автоматическое добавление не-Steam игр в библиотеку Steam: автопоиск exe и параметров запуска, выбор обложек из разных источников (по возможности локализованных), двухпанельный режим для перемещения папок с играми с автоматическим обновлением путей в Steam.**
...
- **Добавлять не-Steam игры в Steam** — с правильным названием, exe-файлом, рабочей папкой, параметрами запуска и полным набором обложек, а не пустым ярлыком.
...
**Список игр**
- Две независимые панели (**C** и **D**), каждая для любой папки.
...
- По желанию: бесплатный [API-ключ SteamGridDB](https://www.steamgriddb.com/profile/preferences) для источника SteamGridDB.
...
2. *(По желанию)* Вставьте API-ключ SteamGridDB. Под полем появится статус: ключ рабочий, отозван или сервис недоступен.
3. Выберите папку с играми для панели **C** и, если хотите переносить игры между дисками, вторую папку для панели **D**.
